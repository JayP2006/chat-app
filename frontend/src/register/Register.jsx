...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('https://chatobi-backend.onrender.com/api/auth/register', formData);
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 bg-white text-gray-800 placeholder-gray-400"
              />
            </div>
